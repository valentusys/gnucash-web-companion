...
- Phase 221 evaluated `v0.2.5-writealpha` and recorded an explicit no-release verdict because Phase
  ...
  amount-like, memo/account-name, and payload-like data before commit, and Phase 237 added an
  ...
  testing without changing default read-only config. Write-alpha remains pre-alpha/experimental,
  disabled by default,
