...
export type MessageKey =
	...
	| 'transactions.filters.clearDates'
	| 'transactions.filters.edit'
	| 'ui.technicalInfo'
	| 'ui.openDiagnostics'
	| 'transactions.accountChoicesLimited'
	| 'transactions.accountChoicesUnavailable'
	| 'transactions.accountChoicesHelp'
	| 'transactionCreate.accountChoicesLimited'
	| 'transactionCreate.accountChoicesUnavailable'
	| 'transactionCreate.accountChoicesLimitedHelp'
	| 'transactionCreate.accountChoicesUnavailableHelp'
	| 'transactions.previewAction'
	| 'transactions.previewHelpShort'
...
export const messages: Record<Locale, Record<MessageKey, string>> = {
	en: {
		...
		'transactionCreate.subtitle': 'Review a draft without saving. Saving requires a separate confirmation permitted by the server.',
		...
		'transactionCreate.previewHelp': 'Checking a draft does not save it. The server decides whether saving is permitted.',
		...
		'transactions.filters.clearDates': 'Clear dates',
		'transactions.filters.edit': 'Edit filters',
		'ui.technicalInfo': 'Technical information',
		'ui.openDiagnostics': 'Open diagnostics',
		'transactions.accountChoicesLimited': 'Account choices are partially limited',
		'transactions.accountChoicesUnavailable': 'Account-specific filters are temporarily unavailable',
		'transactions.accountChoicesHelp': 'Transactions remain available. Type, date, state, and search filters continue to work.',
		'transactionCreate.accountChoicesLimited': 'Posting-account choices are partially limited',
		'transactionCreate.accountChoicesUnavailable': 'Posting-account choices are temporarily unavailable',
		'transactionCreate.accountChoicesLimitedHelp': 'Only some posting accounts are available. Preview remains usable with these accounts.',
		'transactionCreate.accountChoicesUnavailableHelp': 'Account selection and preview submission are disabled. Other read-only views remain available.',
		'transactions.previewAction': 'New draft',
		'transactions.previewHelpShort': 'Review a draft without saving it.',
		...
		'transactions.explorer.cursorPagination': 'Pages',
	...
	ru: {
		...
		'accounts.loading': 'Загрузка дерева счетов…',
		...
		'accounts.emptyMessage': 'В выбранной книге нет доступных счетов. Проверьте выбранную книгу и права доступа.',
		...
		'accounts.explorer.formHelp':
			'Фильтры сохраняются в адресе страницы. Поиск не меняет книгу; параметры проверяются до чтения счетов.',
		...
		'accounts.explorer.readyTitle': 'Счета загружены',
		'accounts.explorer.readyMessage': 'Показаны счета по выбранным фильтрам.',
		'accounts.explorer.noMatchesTitle': 'Нет счетов по этим фильтрам',
		'accounts.explorer.noMatchesMessage': 'Совпадений нет. Сбросьте фильтры или измените поиск, тип и видимость счетов.',
		'accounts.explorer.invalidFilterTitle': 'Некорректные фильтры счетов',
		'accounts.explorer.invalidFilterMessage': 'Параметры отклонены до чтения счетов. Исправьте адрес страницы или сбросьте фильтры.',
		'accounts.explorer.narrowFiltersTitle': 'Сузьте фильтры счетов',
		'accounts.explorer.narrowFiltersMessage': 'Результат слишком большой или сложный. Уточните поиск, тип или видимость счетов и повторите.',
		'accounts.explorer.loadFailedTitle': 'Не удалось загрузить счета',
		'accounts.explorer.loadFailedMessage': 'Не удалось прочитать счета. Повторите запрос. Книга не изменена; служебные данные скрыты.',
		'accounts.explorer.unknownFailureTitle': 'Просмотр счетов недоступен',
		'accounts.explorer.unknownFailureMessage': 'Сервис вернул неизвестную ошибку. Повторите запрос. Служебные данные скрыты.',
		'accounts.explorer.statusCounts': 'Показано счетов: {returned}. Проверено: {candidates}.',
		'accounts.explorer.warningsTitle': 'Особенности счетов',
		'accounts.explorer.contextWarning': 'Родительские счета включены, чтобы показать путь к совпадениям.',
		'accounts.explorer.hiddenWarning': 'Скрытые счета показаны по выбранным фильтрам.',
		'accounts.explorer.placeholderWarning': 'Группы не принимают прямые проводки. Их итоги включают дочерние счета.',
		'accounts.explorer.repairedWarning': 'Есть потерянные родители или циклы. Исправлено только отображение дерева, не книга.',
		'accounts.explorer.mixedCommodityWarning': 'Остатки по валютам и ценным бумагам показаны отдельно, без конвертации и общего итога.',
		'accounts.explorer.resultsLabel': 'Счета по выбранным фильтрам',
		...
		'accounts.explorer.balanceDetailsHelp': 'Точные остатки показаны отдельно по валютам и ценным бумагам, без конвертации и общего итога.',
		...
		'transactionCreate.subtitle': 'Проверьте черновик без сохранения. Запись требует отдельного разрешённого подтверждения.',
		'transactionCreate.policyTitle': 'Условия сохранения',
		...
		'transactionCreate.policyUnknown': 'Решение принимает сервер',
		'transactionCreate.policyServerDecided': 'Доступность сохранения станет известна после проверки черновика.',
		'transactionCreate.visibleAccounts': 'Доступные счета',
		'transactionCreate.scopeTitle': 'Ограничения',
		'transactionCreate.scopeCopy': 'От 2 до 50 проводок в одной валюте. Без изменения и удаления существующих операций, импорта и банковских действий.',
		'transactionCreate.requestFailedTitle': 'Не удалось выполнить запрос',
		'transactionCreate.requestRef': 'Код запроса',
		'transactionCreate.recoveryRef': 'Код восстановления',
		...
		'transactionCreate.splitEditorTitle': 'Проводки',
		'transactionCreate.splitEditorHelp': 'От 2 до 50 строк. Укажите точные суммы со знаком; их сумма должна равняться нулю.',
		'transactionCreate.addSplit': 'Добавить проводку',
		'transactionCreate.addSplitLimit': 'Достигнут предел: 50 проводок',
		'transactionCreate.runningBalance': 'Сумма проводок',
		'transactionCreate.splitLegend': 'Проводка',
		'transactionCreate.accountLabel': 'Счёт',
		'transactionCreate.accountChoose': 'Выберите счёт',
		'transactionCreate.amountLabel': 'Сумма',
		'transactionCreate.memoLabel': 'Примечание',
		'transactionCreate.selectedAccount': 'Выбранный счёт',
		'transactionCreate.none': 'нет',
		'transactionCreate.moveUp': 'Вверх',
		'transactionCreate.moveDown': 'Вниз',
		'transactionCreate.removeSplit': 'Удалить проводку',
		'transactionCreate.previewHelp': 'Проверка не сохраняет изменения. Возможность сохранения определяет сервер.',
		'transactionCreate.previewSubmit': 'Предпросмотр транзакции',
		'transactionCreate.previewStaleTitle': 'Черновик изменён после проверки',
		'transactionCreate.normalizedPreviewTitle': 'Результат проверки',
		'transactionCreate.confirmAllowed': 'Сохранение разрешено',
		'transactionCreate.createCount': 'Число новых операций',
		'transactionCreate.expiresAt': 'Действует до',
		'transactionCreate.generation': 'Версия разрешения',
		'transactionCreate.previewSplit': 'Проводка',
		'transactionCreate.memoDisplay': 'Примечание',
		'transactionCreate.confirmTitle': 'Подтверждение сохранения',
		'transactionCreate.confirmHelp': 'Будет сохранена одна проверенная операция. Повторное подтверждение не создаёт дубликат.',
		'transactionCreate.confirmSubmit': 'Подтвердить сохранение',
		'transactionCreate.confirmUnavailableTitle': 'Сохранение недоступно',
		'transactionCreate.confirmUnavailableHelp': 'Нужны разрешение сервера и актуальная проверка черновика.',
		...
		'transactionCreate.balanceZero': 'Сумма проводок равна нулю.',
		'transactionCreate.balanceNonZero': 'Сумма проводок должна быть равна нулю перед проверкой и сохранением.',
		'transactionCreate.previewStale': 'Черновик изменён. Повторите проверку перед сохранением.',
		'transactionCreate.success.created': 'Транзакция создана. Проверьте безопасные ссылки ниже.',
		'transactionCreate.success.already_created': 'Эта операция уже была сохранена. Показан прежний результат без создания дубликата.',
		'transactionCreate.error.generic': 'Запрос не удалось завершить. Технические подробности скрыты.',
		'transactionCreate.error.CREATE_DEPLOYMENT_DISABLED': 'Сохранение отключено настройками приложения.',
		'transactionCreate.error.CREATE_BOOK_DISABLED': 'Сохранение отключено для этой книги.',
		'transactionCreate.error.CREATE_PERMISSION_DENIED': 'Требуется разрешение владельца или редактора книги.',
		'transactionCreate.error.PREVIEW_TOKEN_EXPIRED': 'Срок проверки истёк. Проверьте черновик повторно.',
		'transactionCreate.error.PREVIEW_TOKEN_INVALID': 'Разрешение проверки отклонено. Проверьте черновик повторно.',
		'transactionCreate.error.PREVIEW_PAYLOAD_MISMATCH': 'Черновик изменён. Проверьте его повторно.',
		'transactionCreate.error.PREVIEW_STALE': 'Книга или разрешения изменились. Проверьте черновик повторно.',
		'transactionCreate.error.IDEMPOTENCY_PAYLOAD_MISMATCH': 'Код операции уже использован для другого черновика.',
		'transactionCreate.error.CREATE_IN_PROGRESS': 'Эта операция уже выполняется. Дождитесь завершения перед повторной попыткой.',
		'transactionCreate.error.BOOK_WRITE_BUSY': 'Книга занята другой записью. Дождитесь её завершения.',
		'transactionCreate.error.CREATE_RECOVERY_REQUIRED': 'Перед повторной попыткой требуется восстановление.',
		'transactionCreate.error.INVALID_DATE': 'Используйте строгую дату YYYY-MM-DD.',
		'transactionCreate.error.DESCRIPTION_REQUIRED': 'Укажите описание.',
		'transactionCreate.error.SPLIT_COUNT_OUT_OF_RANGE': 'Требуется от 2 до 50 проводок.',
		'transactionCreate.error.INVALID_DECIMAL': 'Укажите точные десятичные суммы.',
		'transactionCreate.error.ZERO_SPLIT': 'Сумма каждой проводки должна быть ненулевой.',
		'transactionCreate.error.UNBALANCED_SPLITS': 'Сумма проводок должна равняться нулю.',
		'transactionCreate.error.INSUFFICIENT_DISTINCT_ACCOUNTS': 'Выберите минимум два разных счёта.',
		'transactionCreate.error.ACCOUNT_NOT_FOUND': 'Выберите счёт из списка для этой книги.',
		'transactionCreate.error.ACCOUNT_NOT_POSTABLE': 'Выбранный счёт не принимает проводки.',
		'transactionCreate.error.UNSUPPORTED_ACCOUNT_TYPE': 'Операции этого типа счёта не поддерживаются.',
		'transactionCreate.error.UNSUPPORTED_COMMODITY': 'Эта валюта или ценная бумага не поддерживается.',
		'transactionCreate.error.COMMODITY_MISMATCH': 'Все проводки должны быть в выбранной валюте. Пересчёт между валютами не выполняется.',
		'transactionCreate.error.BACKUP_FAILED': 'Не удалось создать резервную копию перед записью. Успех не подтверждён.',
		'transactionCreate.error.WRITE_FAILED': 'Ошибка записи. Перед повторной попыткой проверьте диагностические сведения.',
		'transactionCreate.error.CREATE_RESULT_UNKNOWN': 'Результат сохранения неизвестен. Перед повторной попыткой требуется восстановление.',
		...
		'transactions.filters.clearDates': 'Убрать даты',
		'transactions.filters.edit': 'Изменить фильтры',
		'ui.technicalInfo': 'Техническая информация',
		'ui.openDiagnostics': 'Открыть диагностику',
		'transactions.accountChoicesLimited': 'Список вариантов счетов ограничен',
		'transactions.accountChoicesUnavailable': 'Фильтры по счетам временно недоступны',
		'transactions.accountChoicesHelp': 'Транзакции доступны. Фильтры вида операции, дат, состояния и поиска продолжают работать.',
		'transactionCreate.accountChoicesLimited': 'Список счетов для проводок ограничен',
		'transactionCreate.accountChoicesUnavailable': 'Счета для проводок временно недоступны',
		'transactionCreate.accountChoicesLimitedHelp': 'Доступна только часть счетов для проводок. Предпросмотр с этими счетами остаётся доступен.',
		'transactionCreate.accountChoicesUnavailableHelp': 'Выбор счетов и отправка предпросмотра отключены. Другие разделы просмотра доступны.',
		'transactions.previewAction': 'Новый черновик',
		'transactions.previewHelpShort': 'Проверка черновика без сохранения.',
		'transactions.filters.datePresetAria': 'Быстрые диапазоны дат транзакций',
		'transactions.filters.datePresetHelp':
			'Быстрые даты меняют период списка и экспорта CSV. Книга не изменяется.',
		'transactions.filters.activeSummaryTitle': 'Фильтры списка и экспорта CSV',
		'transactions.filters.search': 'Поиск',
		'transactions.filters.searchPlaceholder': 'Описание или примечание…',
		'transactions.filters.account': 'Счёт',
		'transactions.filters.accountScope': 'Область счёта',
		'transactions.filters.accountId': 'Идентификатор счёта',
		'transactions.filters.lockedAccountHelp':
		...
		'transactions.explorer.formHelp':
			'Фильтры сохраняются в адресе страницы. Изменение условий, сортировки или размера страницы возвращает к началу списка.',
		'transactions.explorer.datePresetHelp': 'Быстрые даты задают начало и конец периода и возвращают к первой странице.',
		'transactions.explorer.dateTextLegend': 'Даты, текст и состояние',
		'transactions.explorer.scopeLegend': 'Счета или вид операции',
		'transactions.explorer.scopeHelp': 'Выберите до 20 счетов либо доходы или расходы. Эти режимы нельзя совмещать.',
		'transactions.explorer.accountIds': 'Счета (до 20)',
		'transactions.explorer.accountIdsHelp': 'Удерживайте Ctrl/Cmd для выбора нескольких счетов. Сумма и направление относятся к проводкам выбранных счетов.',
		'transactions.explorer.accountOptionsLimited': 'Показана только часть вариантов счетов. Для остальных можно задать идентификаторы в параметре account_ids адреса страницы.',
		'transactions.explorer.accountsDisabledByType': 'Выбор счетов отключён в режиме доходов или расходов.',
		'transactions.explorer.type': 'Вид операции',
		'transactions.explorer.typeAny': 'Любой вид',
		'transactions.explorer.typeIncome': 'Доходы',
		'transactions.explorer.typeExpense': 'Расходы',
		'transactions.explorer.direction': 'Направление',
		...
		'transactions.explorer.directionHelp': 'Направление доступно только для выбранных счетов, не в режиме доходов или расходов.',
		'transactions.explorer.amountPagingLegend': 'Сумма и страницы',
		'transactions.explorer.amountPagingHelp': 'Для фильтра суммы выберите счета или вид операции. Дробную часть отделяйте точкой; суммы обрабатываются точно. На странице от 1 до 100 строк.',
		...
		'transactions.explorer.reset': 'Сбросить фильтры',
		'transactions.explorer.removeFilter': 'Убрать фильтр',
		'transactions.explorer.cursorChip': 'Открыто продолжение списка',
		'transactions.explorer.dateRangeRequiredTitle': 'Выберите ограниченный диапазон дат',
		'transactions.explorer.dateRangeRequiredMessage':
			'Укажите начало и конец периода длиной до 366 дней. Без периода список не загружается.',
		'transactions.explorer.readyTitle': 'Страница загружена',
		'transactions.explorer.readyMessage': 'Показана страница операций для выбранных фильтров.',
		'transactions.explorer.trueEmptyTitle': 'Нет транзакций для этих точных фильтров',
		'transactions.explorer.trueEmptyMessage': 'Подходящих операций нет. Измените период, счета или условия поиска.',
		'transactions.explorer.scanWindowEmptyTitle': 'В просмотренной части операций нет',
		'transactions.explorer.scanWindowEmptyMessage': 'Проверена только часть книги. Продолжите просмотр или сузьте фильтры; отсутствие результатов пока не подтверждено.',
		'transactions.explorer.scanLimitedTitle': 'Проверена часть книги',
		...
		'transactions.explorer.scanLimitedMessage': 'Показаны найденные операции, но поиск ещё не завершён. Продолжите просмотр или сузьте фильтры.',
		'transactions.explorer.endTitle': 'Конец списка',
		'transactions.explorer.endMessage': 'В продолжении списка больше нет операций. Вернитесь к первой странице или измените фильтры.',
		'transactions.explorer.invalidFilterTitle': 'Некорректные фильтры',
		'transactions.explorer.invalidFilterMessage': 'Не удалось применить выбранные фильтры. Исправьте их или сбросьте поиск.',
		'transactions.explorer.staleCursorTitle': 'Ссылка на страницу устарела',
		'transactions.explorer.staleCursorMessage': 'Ссылка больше не соответствует фильтрам или срок её действия истёк. Начните с первой страницы.',
		'transactions.explorer.loadFailedTitle': 'Не удалось загрузить операции',
		'transactions.explorer.loadFailedMessage': 'Ошибка чтения списка. Книга не изменена; технические подробности скрыты.',
		'transactions.explorer.unknownFailureTitle': 'Список операций недоступен',
		'transactions.explorer.unknownFailureMessage': 'Получена неизвестная ошибка. Технические подробности скрыты.',
		'transactions.explorer.legacyCompatibility': 'Открыта ссылка старого формата. Для новых возможностей сбросьте фильтры и выберите период заново.',
		'transactions.explorer.legacyOffsetConflict': 'Параметры страниц старого и нового формата нельзя совмещать. Сбросьте фильтры.',
		'transactions.explorer.returnedStatus': 'Показано строк: {count}. Размер страницы: {pageSize}.',
		'transactions.explorer.filtersApplied': 'Активных условий: {count}. Список, детали и переходы по страницам сохраняют фильтры.',
		'transactions.explorer.noFilters': 'Дополнительные фильтры не заданы. Сортировка и размер страницы сохранены в адресе.',
		'transactions.explorer.order': 'Порядок: {sort}. При одинаковой дате операции упорядочены по идентификатору.',
		'transactions.explorer.noTotal': 'Общее число строк не вычисляется. Для навигации используйте кнопки перехода по страницам.',
		'transactions.explorer.limitationsTitle': 'Ограничения списка',
		'transactions.explorer.resetPagination': 'К первой странице',
		'transactions.explorer.paginationLabel': 'Страницы списка операций',
		'transactions.explorer.cursorPagination': 'Страницы',
