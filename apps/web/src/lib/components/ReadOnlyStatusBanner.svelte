...
>
	<div class="mx-auto flex max-w-5xl flex-col gap-2 md:flex-row md:items-center md:justify-between">
		<div class="flex min-w-0 flex-col gap-1 sm:flex-row sm:flex-wrap sm:items-center sm:gap-2 font-medium">
