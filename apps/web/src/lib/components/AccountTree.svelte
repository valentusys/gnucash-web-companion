...
<div class="overflow-hidden rounded-2xl" style="background-color: var(--app-panel); box-shadow: 0 1px 3px var(--app-panel-shadow); border: 1px solid var(--app-border);">
	<div class="hidden grid-cols-[1fr_8rem_10rem_5rem] px-4 py-2 text-xs font-semibold uppercase tracking-wide md:grid" style="background-color: var(--app-elevated-bg); color: var(--app-muted);">
		<div>Name</div>
		<div>Type</div>
