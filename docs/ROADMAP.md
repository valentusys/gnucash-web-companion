...
- Latest public release baseline: Phase 261 published `v0.2.8-writealpha` after PM authorization,
  ...
  278 refreshed the copied-book write-alpha posture. Phase 279 invoked PM and recorded a no-release verdict. PATCH/DELETE remain not run and not authorized.
