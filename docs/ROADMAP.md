...
### Release governance and agent continuity — Phases 15–16 and 25–29

Completed public pre-alpha release setup, Project Lead context, release/status documentation synchronization, audit-driven fixes, discoverability docs, compatibility matrix, and Phase 29 audit documentation refresh.
