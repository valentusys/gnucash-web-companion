# Phase 592 — PM trusted tester policy

Goal: PM trusted tester policy.
...
- `docs/handoff/phase-592.md`

Findings:
- PM decision: Trusted writebeta docs allowed; no public/trusted release.
