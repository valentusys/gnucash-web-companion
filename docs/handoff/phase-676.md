# Phase 676 — Implement failed hard-stop behavior

Goal: Implement failed hard-stop behavior.
...
Acceptance criteria: failed_hard_stop is terminal and writes_blocked.
