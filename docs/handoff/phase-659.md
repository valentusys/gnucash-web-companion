# Phase 659 — PM compatibility release decision

Goal: PM compatibility release decision.
...
Acceptance criteria: PM: include compatibility workflow in final public read-only patch candidate.
