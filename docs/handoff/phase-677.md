# Phase 677 — Implement state-machine UI integration

Goal: Implement state-machine UI integration.
...
Acceptance criteria: No write UI expansion in this run; docs describe safe operator state visibility as follow-up.
