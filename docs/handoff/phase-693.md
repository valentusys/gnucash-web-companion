# Phase 693 — Implement failed-restore hard-stop tests/UI

Goal: Implement failed-restore hard-stop tests/UI.
...
Acceptance criteria: State-machine tests cover terminal failed_hard_stop; UI remains follow-up.
