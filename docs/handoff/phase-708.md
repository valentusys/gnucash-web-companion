# Phase 708 — Owner operating guide update

Goal: Owner operating guide update.
...
Acceptance criteria: Guide says copied-book-only until full gates and exact authorization.
