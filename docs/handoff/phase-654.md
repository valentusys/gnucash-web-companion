# Phase 654 — Add compatibility self-report helper

Goal: Add compatibility self-report helper.
...
Acceptance criteria: Added scripts/safe_compatibility_report.py with redaction and tests.
