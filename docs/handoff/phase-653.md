# Phase 653 — Implement compatibility issue template

Goal: Implement compatibility issue template.
...
Acceptance criteria: Added .github/ISSUE_TEMPLATE/compatibility-report.yml with explicit forbidden data checklist.
