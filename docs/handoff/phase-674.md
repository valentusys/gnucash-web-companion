# Phase 674 — Integrate preflight and preview states

Goal: Integrate preflight and preview states.
...
Acceptance criteria: State machine blocks confirmation/mutation before preflight/preview path.
