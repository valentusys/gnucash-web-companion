# Issue #36 real working-book trial blocker runbook R10 handoff

Date: 2026-06-06
Task id: `real-working-book-trial-blocker-runbook-r10`
...
Updated `docs/write-alpha/real-working-book-trial-runbook.md` with R10
non-mutating blocker detail:

- a future blocker ledger covering approval identity, target safety, runtime
  safety, rollback readiness, evidence hygiene, and non-release posture;
- explicit rule that missing, stale, contradictory, or private-evidence-dependent
  ledger rows block the trial before mutation;
- owner rollback acknowledgement expectations that treat failed route, audit,
  read-back, compatibility, restore-to-copy, reset, or disabled-probe evidence as
