# Issue #36 final full gate report r3

Date: 2026-06-05
Task id: final-full-gate-report-r3
...
```text
796 passed, 38 warnings in 274.07s (0:04:34)
```
...
Loading svelte-check in workspace: <repo>/apps/web
