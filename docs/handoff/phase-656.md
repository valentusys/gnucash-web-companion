# Phase 656 — Compatibility redaction tests

Goal: Compatibility redaction tests.
...
Acceptance criteria: Added helper regression test for path and amount redaction.
