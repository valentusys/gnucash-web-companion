# Phase 644 — Implement diagnostics UI page/panel

Goal: Implement diagnostics UI page/panel.
...
Acceptance criteria: Added /diagnostics public first-run page and home link; no write controls.
