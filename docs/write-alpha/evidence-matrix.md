...
Status: refreshed in Phase 296 after the Phase 295 audit accepted Phase 294 evidence narrowly.
...
- Owner copied-book evidence currently supports: dry-run accepted, CREATE evidence accepted for bounded copied-book runs, Phase 294/295 fresh-chain evidence accepted for one metadata/memo-only PATCH on its same write-alpha-created transaction, DELETE blocked/not run.
