...
| Phase 111 Desktop-tooling availability probe | SQLite fixture not produced by Desktop in this environment | no new Desktop-generated schema marker; existing generated fixture markers remain `Gnucash = 3000000`, `Gnucash-Resave = 19920` | safe probe records whether `gnucash` / `gnucash-cli` are available and records bounded `--version` output only when present; no book is opened and no private directories are searched | Tested by `tests/test_gnucash_compatibility_metadata.py`; local probe result was `desktop_tooling_available=false`, so this is reproducibility/evidence hygiene, not a real Desktop-generated compatibility row |
| Phase 127 Desktop compatibility evidence refresh | SQLite fixture not produced by Desktop in this environment | no new Desktop-generated schema marker; existing generated fixture markers remain `Gnucash = 3000000`, `Gnucash-Resave = 19920` | re-ran `gnucash --version`, `gnucash-cli --version`, and the safe tooling probe; both commands were unavailable, so no synthetic Desktop-generated book could be created in this environment | Blocker documented for GitHub #22; regression coverage in `tests/test_compatibility_fixture_v1.py` asserts missing Desktop tooling is treated as a safe blocker, not Desktop evidence |
