...
This matrix is intentionally narrow. The rows below prove behavior against committed or generated synthetic SQLite books and safe metadata/probe procedures. They do not prove broad compatibility with every GnuCash Desktop release, SQL backend, operating system, or real user book.
