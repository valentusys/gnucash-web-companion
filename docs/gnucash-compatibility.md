...
Issue #22 is closed for narrow Desktop-generated synthetic SQLite fixture evidence only. The
fixture was generated by GnuCash 5.14 Desktop in an isolated Xvfb session and passed fail-closed
preflight plus default-read-only validation without mutation.
No broad GnuCash Desktop version support is claimed. PostgreSQL/MySQL/MariaDB GnuCash backends are
unclaimed.
...
| Issue #22 isolated Desktop synthetic fixture, 2026-06-04 | SQLite | Desktop-generated synthetic/disposable fixture; raw DB remains outside git | GnuCash 5.14 Desktop generated and saved the disposable book in isolated Xvfb; this is narrow fixture evidence only, not a broad version support claim | redacted collector recorded `Gnucash = 3000000`, `Gnucash-Resave = 19920`; selected safe table counts only | fail-closed preflight accepted redacted metadata; default-read-only service validation opened accounts/summary/report paths with `GNUCASH_WRITES_ENABLED=false`; checksum unchanged | Tested locally for #22; raw DB, screenshots, logs, paths, account names, transaction descriptions, memos, amounts, backups, and app DBs were not committed |
...
## GnuCash Desktop-generated fixture evidence

One isolated GnuCash Desktop-generated synthetic SQLite fixture has passed the #22 gate. Current compatibility evidence remains synthetic/disposable only:
...
- repeated earlier local checks where `gnucash` and `gnucash-cli` were unavailable, so no Desktop-generated fixture could be produced at that time.
- GnuCash 5.14 Desktop generated a disposable synthetic SQLite book in an isolated Xvfb session on 2026-06-04; fail-closed preflight and default-read-only service validation passed with checksum unchanged.
...
- The first 2026-06-04 #22 attempt found host `gnucash`/`gnucash-cli` tooling, including `gnucash-cli` GnuCash 5.14 version output, but no display, `xvfb-run`, `Xvfb`, or `xdotool`; no safe noninteractive create/save SQLite fixture command was found. That blocker was later resolved by installing GUI automation tooling with explicit operator approval and running GnuCash Desktop in isolated Xvfb.
...
The project does not commit raw Desktop-generated fixture books. Compatibility must still be described conservatively:
...
- The 2026-06-04 #22 closure packet followed the runbook at [docs/compatibility/desktop-synthetic-fixture-runbook.md](compatibility/desktop-synthetic-fixture-runbook.md) in an isolated Xvfb session. The generated raw SQLite book stayed outside git; only redacted metadata and validator output were used to close #22 narrowly.
