...
- Status: pre-alpha / v0.1.7-readonly remains the current public read-only pre-release;
  ...
  Phase 270. Phase 231 ran the `v0.2.5-writealpha` final release gate after Phase 230 green
...
- `v0.2.8-writealpha` is the current public experimental write-alpha GitHub pre-release after Phase
  ...
  dry-run-only entrypoint evidence plus Phase 267 fresh-clone synthetic rehearsal evidence; Phase 268 says the owner may be asked for dry-run only, Phase 269 provides the request packet, but owner dry-run evidence is still absent, not production-ready, not
