...
- Latest handoffs/docs: `docs/handoff/release-no-release-decision-docs-r6.md`,
...
- Current #36 docs reconciliation: owner-writebeta remains maintenance-only and unreleased until
  ...
  decision rather than infer approval from readiness docs. The r6 release/no-release documentation
  pass adds reviewer interpretation tables and a release-artifact stop line so maintenance evidence
  cannot be read as permission to prepare tags, release notes, packages, images, or public write-beta
  wording.
