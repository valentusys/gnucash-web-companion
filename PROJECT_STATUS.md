...
- Branch: `main`
- Status: pre-alpha / v0.1.5-readonly read-only pre-release published through Phase 152; v0.2.0-writealpha remains a separate experimental pre-release

## Current baseline

Completed through Phase 152.
